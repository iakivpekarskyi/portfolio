...
import id_img from '@/public/id_photo.jpg';
...
export default function Intro() {
  ...
  return (
    <section
      ...
      <motion.div
        className='flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-4 py-8 text-lg font-medium'
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{
          delay: 0.1,
        ...
        <a
          ...
          href='https://www.linkedin.com/in/iakiv-pekarskyi/'
          target='_blank'>
          <BsLinkedin />
        </a>
        <a
          className='bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer border-black/10  dark:bg-white/10 dark:text-white/60'
          href='https://github.com/iakivpekarskyi'
          target='_blank'>
          <FaGithubSquare />
        </a>
      </motion.div>
